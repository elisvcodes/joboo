...
var createPaymentIntent = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, amount, name, email, customer, paymentIntent, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, amount = _a.amount, name = _a.name, email = _a.email;
                _b.label = 1;
            case 1:
                _b.trys.push([1, 4, , 5]);
                return [4 /*yield*/, stripe.customers.create({ name: name, email: email })];
            case 2:
                customer = _b.sent();
